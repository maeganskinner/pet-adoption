    ...
    <section class="section background">
      <div class="main-container">
        <header class="section__header">
          <h2 class="title section__title"> Meet The Squad </h2>
        </header>
        <div class="section__content teamy-team">
          <article class="teamy teamy_style1 teamy_mask-circle">
            <div class="teamy__layout">
              <div class="teamy__preview">
                <img src="https://images.pexels.com/photos/1036623/pexels-photo-1036623.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="teamy__avatar" alt="The demo " />
              </div>
          ...
          <article class="teamy teamy_style1 teamy_mask-circle teamy_zoom-photo">
            <div class="teamy__layout">
              <div class="teamy__preview">
                <img src="https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="teamy__avatar" alt="The demo " />
              </div>
              <div class="teamy__back">
                <div class="teamy__back-inner">
          ...
          <article class="teamy teamy_style1 teamy_mask-circle teamy_zoom-rotate-photo">
            <div class="teamy__layout">
              <div class="teamy__preview">
                <img src="https://images.pexels.com/photos/1065084/pexels-photo-1065084.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="teamy__avatar" alt="The demo " />
              </div>
              <div class="teamy__back">
                <div class="teamy__back-inner">
            ...
            <div class="teamy__content">
              ...
              <span class="teamy__post"> Sunglass Designer </span>
            </div>
          </article>
          <article class="teamy teamy_style1 teamy_mask-circle teamy_zoom-slide-photo">
            <div class="teamy__layout">
              <div class="teamy__preview">
                <img src="https://images.pexels.com/photos/1181519/pexels-photo-1181519.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="teamy__avatar" alt="The demo " />
              </div>
              <div class="teamy__back">
                <div class="teamy__back-inner">
